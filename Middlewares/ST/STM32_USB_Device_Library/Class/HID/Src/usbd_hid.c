...
__ALIGN_BEGIN static uint8_t USBD_HID_CfgFSDesc[USB_HID_CONFIG_DESC_SIZ] __ALIGN_END =
{
  ...
  (uint8_t)(USB_HID_CONFIG_DESC_SIZ & 0xFF),          /* wTotalLength LSB */
  (uint8_t)((USB_HID_CONFIG_DESC_SIZ >> 8) & 0xFF),   /* wTotalLength MSB */
  ...
  0x00,                                               /* nInterfaceProtocol : 0=none, 1=keyboard, 2=mouse, 4=joystick */
  ...
  (uint8_t)(HID_MOUSE_REPORT_DESC_SIZE & 0xFF),       /* wItemLength LSB */
  (uint8_t)((HID_MOUSE_REPORT_DESC_SIZE >> 8) & 0xFF),/* wItemLength MSB */
  ...
  (uint8_t)(HID_EPIN_SIZE & 0xFF),  /* wMaxPacketSize LSB */
  (uint8_t)((HID_EPIN_SIZE >> 8) & 0xFF), /* wMaxPacketSize MSB */
